...
def process (input_image, params, model_params, prevHandFolded, prevKneelingCheck, countHandFolded, countKneelingCheck):
    ...
    # Here i am making change......................................................................................................


    KneelingCheck = checkKneeling(all_peaks)
    print(KneelingCheck)
    HandFolded = checkHandFold(all_peaks)
    print(HandFolded)

    if prevKneelingCheck == KneelingCheck:
        countKneelingCheck += 1
    else:
        countKneelingCheck = 0

    if prevHandFolded == HandFolded:
        countHandFolded += 1
    else:
        countHandFolded = 0

    if countHandFolded >= 5:
        print(".......................Please Change Your Hands Posture, Continously sitting in the same Hand posture..................")
    
    if countKneelingCheck >= 5:
        print(".......................Please Change Your Legs Posture, Continously sitting in the same Leg posture..................")

    prevKneelingCheck = KneelingCheck
    prevHandFolded = HandFolded

    print(countHandFolded, countKneelingCheck)

    print()
    print()
    
    canvasList = [canvas, prevHandFolded, prevKneelingCheck, countHandFolded, countKneelingCheck]
    return canvasList
            ...
            try:
                if (all_peaks[4][0][0:2]):
                    ...
                    if (distance < (armdist + 100) and distance > (armdist - 100) ): #this value 100 is arbitary. this shall be replaced with a calculation which can adjust to different sizes of people.
                        return "Not Folding Hands"
                    else: 
                        return "Folding Hands"
            except Exception as e:
                return "Folding Hands"
    except Exception as e:
        try:
            ...
            return "Unable to detect arm joints"
...
def checkKneeling(all_peaks):
    ...
    try:
        ...
        if (leftdegrees > 60  and rightdegrees > 60): # 60 degrees is trail and error value here. We can tweak this accordingly and results will vary.
            return "Both Legs are in Kneeling"
        elif (rightdegrees > 60):
            return "Right leg is kneeling"
        elif (leftdegrees > 60):
            return "Left leg is kneeling"
        else:
            return "Not kneeling"
        ...
        try:
            ...
            if (f == 0):
                degrees = 180 - degrees
            if (degrees > 60):
                return "Both Legs Kneeling"
            else:
                return "Not Kneeling"
        except Exception as e:
            return "legs not detected"
...
if __name__ == '__main__':
    ...
    if(vi == True):
        ...
        while(1):
            ...
            canvasList = process(frame, params, model_params, prevHandFolded, prevKneelingCheck, countHandFolded, countKneelingCheck)  
            canvas = canvasList[0]  
            prevHandFolded = canvasList[1]
            prevKneelingCheck = canvasList[2]
            countHandFolded = canvasList[3]
            countKneelingCheck = canvasList[4]
